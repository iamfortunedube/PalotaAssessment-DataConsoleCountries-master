...
namespace PalotaInterviewCS
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Task.Run(async () =>
            {
                var countries = await ApiClient.GetCountries(client.BaseAddress.AbsolutePath + "all");
                ...
                int southAfricanGiniPlace=Convert.ToInt32(countries.Where(x => x.Alpha2Code == "ZA").OrderByDescending(i => i.Gini).First().Gini);
                 ...
                 */
                string lowestGiniCountry = countries.OrderBy(i => i.Gini).First().Name;
        ...
        //    {
        //        countries = await response.Content.ReadAsAsync<Country[]>();
        //    }
        //    return countries;
        //}
